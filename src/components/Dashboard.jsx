  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <header className="bg-warm-white border-b border-border sticky top-0 z-40">
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-2 sm:py-0 sm:h-14 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-6">
          ...
          <div className="flex items-center justify-between sm:contents gap-2">
            ...
            <div className="flex items-center gap-1 sm:gap-3 sm:ml-auto">
              {fmtRefreshed && (
